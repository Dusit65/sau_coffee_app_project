...
class _PinUIState extends State<PinUI> {
  List<String> currentPin = ["", "", "", "", "", ""]; // ใช้ list เก็บค่าที่กรอก
  ...
  Widget buildPinDot(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: currentPin[index] == "*" ? Colors.black : Colors.grey, // เปลี่ยนสีตามสถานะ
      ),
    );
  }
  @override
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  obscureText: true, // ปิดการแสดงผลเป็นตัวอักษร
                  maxLength: 6, // จำกัดจำนวนตัวอักษร
                  style: TextStyle(
                    color: Colors.transparent, // ซ่อนตัวเลขที่กรอกใน TextField
                  ),
                  onChanged: (value) {
                    setState(() {
